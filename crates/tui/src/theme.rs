...
impl Theme {
    ...
    pub fn light() -> Self {
        Self {
            ...
            accent: Color::Rgb(0x3a, 0x61, 0xc4),
            ...
            danger: Color::Rgb(0xb3, 0x37, 0x36),
            warning: Color::Rgb(0x9c, 0x56, 0x00),
            dot_working: Color::Rgb(0x9c, 0x56, 0x00),
            dot_awaiting: Color::Rgb(0x3a, 0x61, 0xc4),
            dot_errored: Color::Rgb(0xb3, 0x37, 0x36),
            dot_completed: Color::Rgb(0x00, 0x83, 0x47),
